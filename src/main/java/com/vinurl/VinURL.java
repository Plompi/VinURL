...
public class VinURL implements ModInitializer {
	...
	public static final OwoNetChannel CUSTOM_RECORD_PACKET_CHANNEL = OwoNetChannel.create(CUSTOM_RECORD_PACKET_ID);
	...
	public void onInitialize() {
		...
		ServerPlayNetworking.registerGlobalReceiver(CUSTOM_RECORD_SET_URL, (payload, context) -> {
			...
			player.playSound(SoundEvents.ENTITY_VILLAGER_WORK_CARTOGRAPHER, 1.0f, 1.0f);
